...
const Doe = () => {
  return (
    <section className="container-full bg-stars do position-relative shadow-m">
      <div>
        <Stars />
        ...
        <div className="content-text">
          ...
          <p className="paragraph">
            Cuando se trata de proyectos digitales, Tenemos el toque
          </p>
          <p className="paragraph">
            {" "}
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Alias
            quidem fuga quibusdam exercitationem. Odio sunt perspiciatis quae
            aliquam perferendis praesentium, minus commodi hic consequuntur
            dignissimos fugit voluptate quod iure illum.
          </p>
        </div>
      </div>
    </section>
